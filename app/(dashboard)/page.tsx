...
function FormCardSkeleton() {
  return <Skeleton className='border-2 border-primary-foreground/20 h-[190px] w-full' />
}
  ...
  return (
    <Card>
      ...
      <CardFooter>
        {
          form.published && (
            <Button className='w-full mt-2 text-md gap-4' variant={'secondary'} asChild>
